...
def sync_solrs(source_solr_base_url, target_solr_base_url, core=None, query=DEFAULT_QUERY):
    ...
    retDict = check_sync(source_solr_base_url, target_solr_base_url, core=core, query=query)
    ...
    if retDict['status']:
        ...
        while datetime_stop > datetime_min:
            ...
            retDict = check_sync(source_solr_base_url, target_solr_base_url, core=core, query=query, fq=timestamp_query)
